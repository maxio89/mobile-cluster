...
object RastriginWork extends {
  ...
  case class RastriginConfig(n: Int, initialSize: Int, maxSize: Int, xover: Double, mu: Double, maxCycles: Int, snapshotFreq: Int, migrationFreq: Int, migrationFactor: Int, leavePopulation: Boolean) extends Config
